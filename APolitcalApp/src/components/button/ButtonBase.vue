...
/* TODO: Put code for the 4 sizes of figma buttons in the template section 
        lg, md, sm, xs, can use same color and icon for all of them. I will make this dynamic later
        i want to live on hamburger*/
</script>
...
<button type="button" class="text-light bg-[#5F8173] hover:bg-[#5F8173]/90  h-14 w-[132px] focus:ring-4 focus:outline-none focus:ring-[#5F8173]/50 font-medium rounded-full text-xs px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
...
<button type="button" class="text-light bg-[#353B3C] hover:bg-[#353B3C]/90  h-14 w-[132px] focus:ring-4 focus:outline-none focus:ring-[#353B3C]/50 font-medium rounded-full text-xs px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
  <svg class="w-8 h-8 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
...
<button type="button" class="text-light bg-[#439A86] hover:bg-[#439A86]/90  h-14 w-[132px] focus:ring-4 focus:outline-none focus:ring-[#439A86]/50 font-medium rounded-full text-xs px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
  <svg class="w-8 h-8 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
...
<button type="button" class="text-light bg-[#439A86] hover:bg-[#439A86]/90 h-[56px] w-[56px] focus:ring-4 focus:outline-none focus:ring-[#439A86]/50 font-medium rounded-full text-xs justify px-3 py-2.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M29.3332 14.7734V16C29.3315 18.8753 28.4005 21.6729 26.679 23.9758C24.9574 26.2787 22.5376 27.9633 19.7803 28.7786C17.0231 29.5938 14.0762 29.4959 11.3791 28.4995C8.68208 27.503 6.37938 25.6615 4.81445 23.2494C3.24953 20.8374 2.50623 17.9841 2.69541 15.1151C2.88459 12.2461 3.99611 9.51512 5.86421 7.32945C7.73231 5.14378 10.2569 3.62053 13.0614 2.98688C15.866 2.35324 18.8002 2.64314 21.4265 3.81336 M29.3333 5.33337L16 18.68L12 14.68" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button type="button" class="text-light bg-[#5F8173] hover:bg-[#5F8173]/90 h-[56px] w-[56px] focus:ring-4 focus:outline-none focus:ring-[#5F8173]/50 font-medium rounded-full text-xs justify px-3 py-2.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M26.6668 14.7733V10.6666L18.6668 2.66663H8.00016C7.29292 2.66663 6.61464 2.94758 6.11454 3.44767C5.61445 3.94777 5.3335 4.62605 5.3335 5.33329V26.6666C5.3335 28.1333 6.5335 29.3333 8.00016 29.3333H16.0002 M18.6665 4V10.6667H25.3332M23.9998 28V20M19.9998 24H27.9998" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
