...
<button type="button" class="text-light bg-dark hover:bg-dark/90 h-[56px] w-[56px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px-3 py-2.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
...
<button type="button" class="text-light bg-[#FFFFFF] hover:bg-dark/90 h-[56px] w-[56px] border-2 border-dark focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px-2.5 py-2.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
...
<button type="button" class="text-light bg-dark hover:bg-dark/90 h-[48px] w-[48px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px-2 py-2 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M7.35986 25.3333C8.2132 22.4 9.8132 21.3333 11.6532 21.3333H20.3465C22.1865 21.3333 23.7865 22.4 24.6399 25.3333 M16 17.3333C18.2091 17.3333 20 15.5425 20 13.3333C20 11.1242 18.2091 9.33331 16 9.33331C13.7909 9.33331 12 11.1242 12 13.3333C12 15.5425 13.7909 17.3333 16 17.3333Z M15.9998 29.3334C23.3636 29.3334 29.3332 23.3638 29.3332 16C29.3332 8.63622 23.3636 2.66669 15.9998 2.66669C8.63604 2.66669 2.6665 8.63622 2.6665 16C2.6665 23.3638 8.63604 29.3334 15.9998 29.3334Z" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button type="button" class="text-light bg-[#FFFFFF] hover:bg-dark/90 h-[48px] w-[48px] border-2 border-dark focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px-1.5 py-1.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M7.35986 25.3333C8.2132 22.4 9.8132 21.3333 11.6532 21.3333H20.3465C22.1865 21.3333 23.7865 22.4 24.6399 25.3333 M16 17.3333C18.2091 17.3333 20 15.5425 20 13.3333C20 11.1242 18.2091 9.33331 16 9.33331C13.7909 9.33331 12 11.1242 12 13.3333C12 15.5425 13.7909 17.3333 16 17.3333Z M15.9998 29.3334C23.3636 29.3334 29.3332 23.3638 29.3332 16C29.3332 8.63622 23.3636 2.66669 15.9998 2.66669C8.63604 2.66669 2.6665 8.63622 2.6665 16C2.6665 23.3638 8.63604 29.3334 15.9998 29.3334Z" stroke="#353B3C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button type="button" class="text-light bg-dark hover:bg-dark/90 h-[32px] w-[32px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px- py-0.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
...
<button type="button" class="text-light bg-dark hover:bg-dark/90 h-[32px] w-[32px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px- py-1 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
...
<button type="button" class="text-light bg-dark hover:bg-dark/90 h-[24px] w-[24px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px-1 py-1 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
...
<button v-if="buttonType === 'deny-lg'" @click="emits('deny')" type="button" class="text-light bg-dark hover:bg-dark/90  h-14 w-[132px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
  <svg class="w-8 h-8 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M16 31C24.2843 31 31 24.2843 31 16C31 7.71573 24.2843 1 16 1C7.71573 1 1 7.71573 1 16C1 24.2843 7.71573 31 16 31Z M5.39502 5.39502L26.605 26.605" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button v-if="buttonType === 'deny-sm'" @click="emits('deny')" type="button" class="text-light bg-dark  hover:bg-dark/90 h-[56px] w-[56px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px-3 py-2.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M16 31C24.2843 31 31 24.2843 31 16C31 7.71573 24.2843 1 16 1C7.71573 1 1 7.71573 1 16C1 24.2843 7.71573 31 16 31Z M5.39502 5.39502L26.605 26.605" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button v-if="buttonType === 'refresh-sm'" @click="emits('refresh')" type="button" class="text-light bg-dark hover:bg-dark/90 h-[56px] w-[56px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px-3 py-2.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M3.3335 2.66663V10.6666H11.3335M28.6668 29.3333V21.3333H20.6668 M29.3332 15.3334C29.2069 12.4154 28.126 9.61958 26.2565 7.37555C24.387 5.13152 21.8324 3.56342 18.9852 2.9122C16.138 2.26098 13.1557 2.56266 10.4966 3.7709C7.83751 4.97914 5.6487 7.02708 4.2665 9.60005M2.6665 16.6667C2.81911 19.574 3.91907 22.3515 5.79841 24.5749C7.67776 26.7984 10.2332 28.3456 13.0744 28.9804C15.9157 29.6151 18.8866 29.3025 21.5335 28.0902C24.1804 26.878 26.3578 24.8327 27.7332 22.2667" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button v-if="buttonType === 'approve-lg'" @click="emits('approve')" type="button" class="text-light bg-highlight hover:bg-highlight/90  h-14 w-[132px] focus:ring-4 focus:outline-none focus:ring-highlight/50 font-medium rounded-full text-xs px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
  <svg class="w-8 h-8 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
...
<button v-if="buttonType === 'approve-sm'" @click="emits('approve')" type="button" class="text-light drop-shadow-md border-dark/30 border bg-highlight hover:bg-highlight/70 h-[56px] w-[56px] focus:ring-4 focus:outline-none focus:ring-highlight/50 font-medium rounded-full text-xs justify px-3 py-2.5 items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
    <svg class="w-8 h-8" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M29.3332 14.7734V16C29.3315 18.8753 28.4005 21.6729 26.679 23.9758C24.9574 26.2787 22.5376 27.9633 19.7803 28.7786C17.0231 29.5938 14.0762 29.4959 11.3791 28.4995C8.68208 27.503 6.37938 25.6615 4.81445 23.2494C3.24953 20.8374 2.50623 17.9841 2.69541 15.1151C2.88459 12.2461 3.99611 9.51512 5.86421 7.32945C7.73231 5.14378 10.2569 3.62053 13.0614 2.98688C15.866 2.35324 18.8002 2.64314 21.4265 3.81336 M29.3333 5.33337L16 18.68L12 14.68" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button v-if="buttonType === 'discard-lg'" @click="emits('discard')" type="button" class="text-light bg-dark hover:bg-dark/90  h-14 w-[132px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2">
  <svg class="w-8 h-8 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M16 31C24.2843 31 31 24.2843 31 16C31 7.71573 24.2843 1 16 1C7.71573 1 1 7.71573 1 16C1 24.2843 7.71573 31 16 31Z M5.39502 5.39502L26.605 26.605" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button v-if="buttonType === 'discard-sm'" @click="emits('discard')" type="button" class="text-light bg-dark hover:bg-dark/90 h-[56px] w-[56px] focus:ring-4 focus:outline-none focus:ring-dark/50 font-medium rounded-full text-xs justify px-3 py-2.5 items-center mr-2 mb-2">
  <svg class="w-8 h-8 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
    viewBox="0 0 32 32">
    <path fill-rule="evenodd" d="M16 31C24.2843 31 31 24.2843 31 16C31 7.71573 24.2843 1 16 1C7.71573 1 1 7.71573 1 16C1 24.2843 7.71573 31 16 31Z M5.39502 5.39502L26.605 26.605" stroke="#FFFFFF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" clip-rule="evenodd"/>
  </svg>
...
<button v-if="buttonType === 'review-sm'" @click="emits('review')" type="button" class="text-light bg-light drop-shadow-md hover:bg-light/90 h-[56px] w-[56px] focus:ring-4 focus:outline-none border-dar focus:ring-dark/50 font-medium rounded-full text-xs justify px-3 py-2.5 items-center mr-2 mb-2">
