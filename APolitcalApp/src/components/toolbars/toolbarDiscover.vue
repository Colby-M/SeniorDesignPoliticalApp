...
<template>
    ...
    <div id="dropdown" class="hidden">
        <div class="bg-border absolute top-20 left-[47%] text-dark z-10 shadow-sm min-w-[100px] flex flex-col gap-1">
            ...
            <p class="py-1 px-5 bg-[#d4d4d4] hover:bg-[#e7e2e2]" @click="filterClicked(1)">a</p>
            <p class="py-1 px-5 bg-[#d4d4d4] hover:bg-[#e7e2e2]" @click="filterClicked(2)">a</p>
            <p class="py-1 px-5 bg-[#d4d4d4] hover:bg-[#e7e2e2]" @click="filterClicked(3)">a</p>
        </div>
    </div>
</template>
<style scoped>
